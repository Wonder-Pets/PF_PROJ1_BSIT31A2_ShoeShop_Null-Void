        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorName = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_Order_ShoeColor",
                table: "PurchaseOrderItems",
                columns: new[] { "PurchaseOrderId", "ShoeColorVariationId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoeColorVariations_Stock_Reorder",
                table: "ShoeColorVariations",
                columns: new[] { "StockQuantity", "ReorderLevel" });
