...
namespace ShoeShop.Repository.Migrations
{
    ...
    [Migration("20251003152934_InitialCreate")]
            ...
            modelBuilder.Entity("ShoeShop.Repository.Entities.PurchaseOrderItem", b =>
                {
                    ...
                    b.HasIndex("PurchaseOrderId", "ShoeColorVariationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("ShoeShop.Repository.Entities.Shoe", b =>
                {
                    ...
                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_Shoes_IsActive");
            ...
            modelBuilder.Entity("ShoeShop.Repository.Entities.ShoeColorVariation", b =>
                {
                    ...
                    b.HasIndex("StockQuantity", "ReorderLevel")
                        .HasDatabaseName("IX_ShoeColorVariations_Stock_Reorder");

                    b.ToTable("ShoeColorVariations", (string)null);
                });
            ...
            modelBuilder.Entity("ShoeShop.Repository.Entities.StockPullOut", b =>
                {
                    ...
                    b.HasIndex("PullOutDate")
                        .HasDatabaseName("IX_StockPullOuts_Date");

                    b.HasIndex("ShoeColorVariationId");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_StockPullOuts_Status");
